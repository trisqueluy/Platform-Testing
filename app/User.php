...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'timeline_id', 'email', 'verification_code', 'email_verified', 'remember_token', 'password', 'birthday', 'city', 'gender', 'last_logged', 'timezone', 'affiliate_id', 'language', 'country', 'active', 'verified', 'facebook_link', 'twitter_link', 'dribbble_link', 'instagram_link', 'youtube_link', 'linkedin_link', 'designation', 'hobbies', 'interests','custom_option1', 'custom_option2', 'custom_option3', 'custom_option4', 'interest', 'interest2', 'sex', 'role',
    ];
    ...
    {
        return $this->timeline->avatar ? url('user/avatar/'.$this->timeline->avatar->source) : url('user/avatar/default-avatar.png');
    }
    ...
    {
        return $this->timeline->interest;
    }
    
    public function getInterest2()
    {
        return $this->timeline->interest2;
    }
}
